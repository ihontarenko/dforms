...
@NamedEntityGraph(
        name = EntityGraphConstants.FORM_WITH_ENTRIES_WITH_FIELD_ENTRIES,
        attributeNodes = {
                @NamedAttributeNode(value = "fieldEntries", subgraph = EntityGraphConstants.FORM_WITH_FIELD_ENTRIES_FIELD)
        },
        subgraphs = {
                @NamedSubgraph(
                        name = EntityGraphConstants.FORM_WITH_FIELD_ENTRIES_FIELD,
