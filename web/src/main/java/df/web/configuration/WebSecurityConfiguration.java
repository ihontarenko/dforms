...
import df.application.security.UserAuthenticationFailureHandler;
import df.application.security.UserAuthenticationSuccessHandler;
import df.application.security.UserInfoService;
import df.application.security.oauth2.OAuth2UserMapperFactory;
import df.application.security.oauth2.OAuth2UserService;
import df.application.security.oauth2.OpenIDUserService;
import df.application.security.oauth2.mapper.GithubOAuth2UserMapper;
import df.application.security.oauth2.mapper.GoogleOAuth2UserMapper;
