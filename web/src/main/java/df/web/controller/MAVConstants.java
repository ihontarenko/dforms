...
public interface MAVConstants {
    ...
    // field config
    String VIEW_FORM_FIELD_CONFIG           = "form/field_setup";
    String REQUEST_MAPPING_FORM_FIELD_SETUP = "/form/field/setup";
    String REDIRECT_FORM_FIELD_SETUP        = REQUEST_MAPPING_FORM_CONFIG + "/%s";
