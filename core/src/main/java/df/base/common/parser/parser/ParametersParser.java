...
import static df.base.common.parser.ExtendedToken.T_CLASS_NAME;
    ...
    public void parse(Lexer lexer, Node parent, ParserContext context) {
        do {
            ...
            if (lexer.isNext(T_OPEN_CURLY_BRACE)) {
                ...
                context.getParser(ArrayParser.class).parse(lexer, parameter, context);
                ...
                context.getParser(ClassNameParser.class).parse(lexer, parameter, context);
            } else {
