...
import df.base.common.libs.ast.recognizer.EnumTokenRecognizer;
import df.base.common.libs.ast.recognizer.JavaTypeTokenRecognizer;
...
public class TokenizerConfigurator implements Configurator<Tokenizer> {
    ...
    public void configure(Tokenizer tokenizer) {
        ...
        tokenizer.addPattern(new TokenizerPattern(Regexps.R_S_INT.regularExpression(), 200));
