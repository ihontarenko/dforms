...
import df.base.common.jbm.bean.context.AnnotationApplicationContext;
import df.base.common.jbm.bean.context.JbmContext;
import df.base.common.jbm.bean.processor.ApplicationContextAwareBeanProcessor;
...
public class JbmExample {
    ...
    public static void main(String... arguments) {
        JbmContext context = AnnotationApplicationContext.run(JbmExample.class);
