...
import df.parent.library.parser.Pattern;
import df.parent.library.parser.PriorityComparator;
import df.parent.library.parser.recognizer.Recognizer;
import df.parent.library.parser.token.Token.Entry;
