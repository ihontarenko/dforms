...
import org.jmouse.core.events.EventManagerSingleton;
...
public class GlobalEntityListener {
    ...
    private final        EventManager eventManager    = EventManagerSingleton.getEventManager(Constants.class);

    @PrePersist
    public void onPrePersist(Object entity) {
        log(PrePersist.class, entity);
        eventManager.publish(new PersistenceEvent("prePersist", entity, this));
    }

    @PostPersist
    public void onPostPersist(Object entity) {
        log(PostPersist.class, entity);
        eventManager.publish(new PersistenceEvent("postPersist", entity, this));
    }

    @PreUpdate
    public void onPreUpdate(Object entity) {
        log(PreUpdate.class, entity);
        eventManager.publish(new PersistenceEvent("preUpdate", entity, this));
    }

    @PostUpdate
    public void onPostUpdate(Object entity) {
        log(PostUpdate.class, entity);
        eventManager.publish(new PersistenceEvent("postUpdate", entity, this));
    }

    @PreRemove
    public void onPreRemove(Object entity) {
        log(PreRemove.class, entity);
        eventManager.publish(new PersistenceEvent("preRemove", entity, this));
    }

    @PostRemove
    public void onPostRemove(Object entity) {
        log(PostRemove.class, entity);
        eventManager.publish(new PersistenceEvent("postRemove", entity, this));
    }
