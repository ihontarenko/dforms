...
import static df.common.matcher.reflection.MethodMatchers.*;
...
public class MethodFilter extends AbstractFilter<Method> {
    ...
    public MethodFilter returnType(Class<?> returnType) {
        ...
        matcher = matcher.and(hasReturnType(returnType));
        return this;
    }
    ...
    public MethodFilter methodName(String methodName) {
        ...
        matcher = matcher.and(nameEquals(Objects.requireNonNull(methodName)));
        return this;
    }
    ...
    public MethodFilter annotated(Class<? extends Annotation> annotationType) {
        ...
        matcher = matcher.and(isAnnotatedWith(annotationType));
        return this;
    }
}
