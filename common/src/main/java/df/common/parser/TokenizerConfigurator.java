...
import df.common.ast.recognizer.PatternTokenRecognizer;
import df.common.ast.token.Tokenizer;
import df.common.ast.token.TokenizerPattern;
...
public class TokenizerConfigurator implements Configurator<Tokenizer> {
    ...
    public void configure(Tokenizer tokenizer) {
        new df.common.ast.token.TokenizerConfigurator().configure(tokenizer);
